...
public class ZookeeperTest2 {
    ...
    private void createZKInstance() throws IOException {
        // 连接到ZK服务，多个可以用逗号分割写
        zk = new ZooKeeper("127.0.0.1:2181,127.0.0.1:2182,127.0.0.1:2183", ZookeeperTest2.SESSION_TIMEOUT, this.wh);
    ...
    private void ZKOperations() throws IOException, InterruptedException, KeeperException {
        ...
        List<String> child=zk.getChildren("/zoo2", wh);
        for(String l : child) {
            System.out.println(l);
        }
        
        byte[] b=zk.getData("/zoo2", wh, stat);
        ...
        byte[] b1=zk.getData("/zoo2", true, stat);
    ...
    public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
        ZookeeperTest2 dm = new ZookeeperTest2();
        dm.createZKInstance();
        dm.ZKOperations();
        dm.ZKClose();
    }
