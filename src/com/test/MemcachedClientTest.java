...
//        Integer[] weights = { 1, 2 };
//        /**
//         * 这个类用来创建管理客户端和服务器通讯连接池，客户端主要的工作包括数据通讯、服务器定位、hash码生成等都是由这个类完成的。 获得连接池的单态方法。这个方法有一个重载方法getInstance( String
//         * poolName )，每个poolName只构造一个SockIOPool实例。 缺省构造的poolName是default。
//         */
